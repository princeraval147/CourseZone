...
const TermAndCondition = () => {
    return (
        <>
            <div style={{ padding: "1rem 4rem", fontFamily: "Georgia, serif" }}>
                ...
                <ul style={{ listStyle: "order" }}>
                    <li>
                        <p>
                            The content of the pages of this website is subject to change notice.
                        </p>
                    </li>
                    <li>
                        <p>
                            Neither we nor any third parties provide any warranty or guarantee as the accuracy, timeliness, performance, completeness or suitability of the information and materials found or offered on this website for any particular purpose. You acknowledge that such information and materials may contain inaccuracies or errors and we expressly exclude liability for any such inaccuracies or errors to the fullest extent permitted by law.
                        </p>
                    </li>
                    <li>
                        <p>
                    ...
                    <li>
                        <p>
                            You may not create a link to our website from another website or document without CourseZone's prior written consent.
                        </p>
                    </li>
                    <li>
                        <p>
                ...
                <br /><br />
                <p>
                    <b> CourseZone </b> believes in helping its customers as far as possible, and has therefore a liberal cancellation policy. Under this policy:
                </p>
                <br />
                ...
                <ul style={{ listStyle: "order" }}>
                    ...
                    <li>
                        <p>
                            Course Zone does not accept cancellation requests for perishable items like flowers, eatables etc. However, refund/replacement can be made if the customer establishes that the quality of product delivered is not good.
                        </p>
                    </li>
                    <li>
                        <p>
                    ...
                    <li>
                        <p>
                            In case of any Refunds approved by the Course Zone, it’ll take 1-2 days for the refund to be processed to the end customer.
                        </p>
                    </li>
                </ul>
            </div >
