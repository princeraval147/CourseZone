...
const { createOrder, verifyPayment, paymentsuccess, getEnrolledStudents, getAllEnrolledStudents, enrolledstudent } = require("../controllers/razorpayController");
...
router.get("/enrolled-students", authenticateAdmin, enrolledstudent);
